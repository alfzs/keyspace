...
Простая утилита для генерации ключей кэша из произвольных частей. Объединяет значения в строку с разделителем `:`, что удобно для использования в in-memory и распределённых кэшах (например, Redis).
